	...
	render: function(){
		...
		return(
			<li style={listStyle.li}> 
				...
				<div style={listStyle.textBlocks} > <a href={'https://www.freecodecamp.com/'+arr.username} ><div style={listStyle.img} ></div>{arr.username}</a></div>
				<div style={listStyle.textBlocks} >{arr.recent}</div>
